...
public class CreateDataFrame extends AbstractProcessor {
    ...
    public static final PropertyDescriptor INFERSCHEMA = new PropertyDescriptor
            .Builder().name("INFERSCHEMA")
    ...
    public void onTrigger(final ProcessContext context, final ProcessSession session) throws ProcessException {
        ...
        if("JSON".equals(format)){
        	sb.append(df_name+" = spark.read.json(\""+location+"\")\n");
        }else {
        sb.append(df_name+" = spark.read.format(\"com.databricks.spark.csv\")"
        		+ ".options(delimiter=',', header = True, inferSchema = True).load(\""
        		+ location+"\")\n");
        }
        sb.append("\n");
        sb.append(df_name+".count()");
        sb.append("\n");
